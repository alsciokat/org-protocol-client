...
`org-insert-link`, add a Roam ref, or open the page in Emacs. A heavily
rewritten fork of
...
- **Protocol menu** — clicking the toolbar icon (or pressing
  `Ctrl+Shift+L` / `⌘⇧L`) opens an in-page menu of your configured protocols.
...
**macOS:** use an app wrapper such as
[EmacsClient.app](https://github.com/neil-smithline-elisp/EmacsClient.app), or
see the [org-protocol documentation](https://orgmode.org/worg/org-contrib/org-protocol.html)
for alternatives.
